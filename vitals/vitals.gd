...
@onready var load_dial = $VBoxContainer/DialMargin/HBoxContainer/VBoxContainer2/LoadDial
@onready var pressure_dial = $VBoxContainer/DialMargin/HBoxContainer/VBoxContainer/PressureDial
